...
CommandStyle(read_bio_restart,ReadBIoRestart)

#else

#ifndef LMP_READ_BIO_RESTART_H
#define LMP_READ_BIO_RESTART_H
...
class ReadBIoRestart : protected Pointers {
 public:
  ReadBIoRestart(class LAMMPS *);
